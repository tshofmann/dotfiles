...
| `~/.config/alias/*.alias` | `terminal/.config/alias/*.alias` | 11 Alias-Dateien (bat, btop, eza, fd, fzf, fzf-tab, gh, git, help, homebrew, ripgrep) |
...
| **ZSH-Plugins** | zsh-syntax-highlighting, zsh-autosuggestions (Homebrew), fzf-tab (Git) | Verschiedene Quellen |
