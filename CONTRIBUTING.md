...
- [Quick Setup (Entwickler)](#quick-setup-entwickler)
- [Repository-Struktur](#repository-struktur)
- [Architektur-Konzepte](#architektur-konzepte)
  - [Unix-Philosophie](#unix-philosophie)
...
- [Git Hooks](#git-hooks)
  ...
  - [Verfügbare Checks](#verfügbare-checks)
  - [Hook schlägt fehl?](#hook-schlägt-fehl)
- [Dokumentations-Validierung](#dokumentations-validierung)
  - [Manuell ausführen](#manuell-ausführen)
  - [Was wird generiert?](#was-wird-generiert)
  - [Bei Fehlern](#bei-fehlern)
- [Sprach- und Kommentar-Richtlinie](#sprach--und-kommentar-richtlinie)
  - [Sprache: Deutsch als erste Wahl](#sprache-deutsch-als-erste-wahl)
  - [Header-Block Format](#header-block-format)
  - [Config-Pfad Ermittlung (SSOT)](#config-pfad-ermittlung-ssot)
  - [tldr-Dokumentation für Tools ohne Aliase](#tldr-dokumentation-für-tools-ohne-aliase)
  - [Funktions- und Alias-Kommentare](#funktions--und-alias-kommentare)
  - [Ausnahmen vom Header-Format](#ausnahmen-vom-header-format)
- [Theming (Catppuccin Mocha)](#theming-catppuccin-mocha)
  - [Grundregeln](#grundregeln)
  - [Bei neuen Tool-Konfigurationen](#bei-neuen-tool-konfigurationen)
  - [Status-Dokumentation](#status-dokumentation)
- [Code-Konventionen](#code-konventionen)
  - [Shell-Scripts](#shell-scripts)
  - [Alias-Dateien](#alias-dateien)
  - [Funktions-Syntax](#funktions-syntax)
  - [Stil-Regeln](#stil-regeln)
  - [Dokumentation](#dokumentation)
- [Pull Request Workflow](#pull-request-workflow)
  - [1. Branch erstellen](#1-branch-erstellen)
  - [2. Änderungen vornehmen](#2-änderungen-vornehmen)
  - [3. Testen](#3-testen)
  - [4. Committen](#4-committen)
  - [5. Push & PR](#5-push--pr)
  - [6. Labels setzen](#6-labels-setzen)
  - [7. PR-Checkliste ausfüllen](#7-pr-checkliste-ausfüllen)
